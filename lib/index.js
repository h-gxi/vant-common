import { getCurrentInstance, ref, computed, onMounted, nextTick, openBlock, createElementBlock, normalizeStyle, createElementVNode, renderSlot, createCommentVNode, unref, inject, onUnmounted, reactive, onDeactivated, isRef, watch, provide, onActivated, isVNode, defineComponent, normalizeClass, Fragment, renderList, createTextVNode, toDisplayString, resolveComponent, createBlock, resolveDirective, createVNode, withCtx, withDirectives } from "vue";
...
const _sfc_main$6 = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    onMounted(() => {
      if (!props.height) {
        nextTick(() => {
          setTimeout(() => {
            var _a, _b;
            if ((_a = proxy.$refs.headerRef) == null ? void 0 : _a.offsetHeight) {
              offsetHeight.value = ((_b = proxy.$refs.headerRef) == null ? void 0 : _b.offsetHeight) + 3;
            }
          }, 50);
        });
      }
    ...
    __expose({ resize });
    return (_ctx, _cache) => {
      return isSlotsLoaded.value ? (openBlock(), createElementBlock("div", {
        key: 0,
        class: "m-header",
...
const baseComponets = [
  { name: "header", component: _sfc_main$6 }
];
...
const name$3 = "m-table";
const TABLE_KEY = Symbol(name$3);
...
const Table = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$3]]);
const name$2 = "m-table-column";
...
const TableColumn = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$2]]);
...
const name$1 = "m-setps";
const STEPS_KEY = Symbol(name$1);
...
const Setps = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$1]]);
...
const SetpsItem = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render]]);
...
const _sfc_main$1 = /* @__PURE__ */ Object.assign({ name: "MAddress" }, {
  __name: "list",
  props: addressProps,
  emits: ["onSave"],
  setup(__props, { expose: __expose, emit: __emit }) {
...
const _sfc_main = /* @__PURE__ */ Object.assign({ name: "MAddressSelect" }, {
  __name: "select",
  props: addressProps,
  setup(__props) {
    const addressStore = useAddressStore();
...
const AddressComponents = [
  { name: "address", component: _sfc_main$1 },
  { name: "address-select", component: _sfc_main }
];
const components = [
  ...baseComponets,
  ...TableComponents,
