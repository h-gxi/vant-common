...
const name$7 = "m-header";
const HEADER_KEY = Symbol(name$7);
  ...
  setup(props, { emit, slots }) {
    ...
    const resize = () => {
      nextTick(() => {
        ...
        console.log("resize :>> ", offsetHeight.value);
      ...
      if (!props.height) {
        nextTick(() => {
          setTimeout(() => {
            ...
            console.log("offsetHeight.value :>> ", offsetHeight.value);
          }, 50);
        });
      }
    });
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$7]]);
const BaseComponets = [
