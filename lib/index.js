...
function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return !_ctx.isWeiXin ? (openBlock(), createBlock(_component_van_nav_bar, {
    key: 0,
    class: "m-nav-bar",
    ...
    _: 1
  }, 8, ["left-text", "right-text", "left-arrow", "border", "fixed", "placeholder", "z-index", "onClickLeft"])) : createCommentVNode("", true);
}
