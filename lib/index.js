...
const name$b = "m-header";
const HEADER_KEY = Symbol(name$b);
...
const name$9 = "m-noticebar-swipe";
...
const Setps = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$5]]);
Setps.install = function(Vue) {
  Vue.component(Setps.name, Setps);
};
const name$7 = "m-setps-item";
...
const SetpsItem = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$4]]);
SetpsItem.install = function(Vue) {
  Vue.component(SetpsItem.name, SetpsItem);
};
const listProps = {
...
const _hoisted_1$4 = { class: "m-list" };
...
const List = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$3]]);
List.install = function(Vue) {
  Vue.component(List.name, List);
};
const name$5 = "m-list-cell";
...
const ListCell = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$2]]);
...
const resolveChecked = (state, node) => {
  if (node.checked) {
    ...
    const { id, name: name2, type: type2, photo, checked, checkedAll, breadcrumb } = node;
    const parent = breadcrumb.map((v) => {
      return { id: v.id, title: v.title };
    });
    state.checkedMap.set(node.id, { id, name: name2, type: type2, photo, checked, checkedAll, parent });
...
const resolveParentChecked = (state, parentId, isChecked) => {
  if (parentId) {
    ...
    if (parentNode) {
      ...
      const { id, name: name2, type: type2, photo, checked, checkedAll, breadcrumb } = parentNode;
      const parent = breadcrumb.map((v) => {
        return { id: v.id, title: v.title };
      });
      state.checkedMap.set(parentNode.id, { id, name: name2, type: type2, photo, checked, checkedAll, parent });
...
const _hoisted_1$3 = { class: "m-address" };
const _hoisted_2$3 = /* @__PURE__ */ createElementVNode("div", { class: "gray-divider" }, null, -1);
const _hoisted_3$2 = { class: "m-address-breadcrumb" };
...
const name$4 = "m-address";
const _sfc_main$3 = /* @__PURE__ */ Object.assign({ name: name$4 }, {
  __name: "list",
  props: addressProps,
  emits: ["onSave"],
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createVNode(_component_m_header, null, {
          default: withCtx(() => [
            createVNode(_component_m_nav_bar, {
              title: unref(title),
              onClickLeft: _cache[0] || (_cache[0] = ($event) => _ctx.$router.back())
            }, null, 8, ["title"]),
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(breadcrumbNode.value, (item, index2) => {
                return openBlock(), createElementBlock(Fragment, { key: index2 }, [
                  index2 < breadcrumbNode.value.length - 1 ? (openBlock(), createElementBlock("span", {
                    ...
                    createTextVNode(toDisplayString(item.title), 1),
                    _hoisted_5$1
                  ], 8, _hoisted_4$2)) : (openBlock(), createElementBlock("span", _hoisted_6$1, toDisplayString(item.title), 1))
                ], 64);
              }), 128))
            ])
          ]),
...
const _hoisted_2$2 = /* @__PURE__ */ createElementVNode("div", { class: "gray-divider" }, null, -1);
const _hoisted_3$1 = { class: "m-address-select-list" };
...
const name$3 = "m-address-select";
const _sfc_main$2 = /* @__PURE__ */ Object.assign({ name: name$3 }, {
  __name: "select",
  props: addressProps,
  setup(__props) {
    const addressStore = useAddressStore();
...
const name$2 = "m-table";
const TABLE_KEY = Symbol(name$2);
...
const _hoisted_1$1 = { class: "m-table__header" };
...
const _sfc_main = defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    const onSortable = () => {
      ...
      parent.setOrder(props.sortable, props.prop, type2);
    };
    return {
      order,
      isSticky,
...
const _hoisted_2 = /* @__PURE__ */ createElementVNode("i", { class: "sort-caret ascending" }, null, -1);
const _hoisted_3 = /* @__PURE__ */ createElementVNode("i", { class: "sort-caret descending" }, null, -1);
const _hoisted_4 = [
  _hoisted_2,
  _hoisted_3
];
...
const index = "";
const name = "vant-common";
const description = "基于vant3封装的自定义组件库，适用于H5开发迭代，降低开发维护成本。";
const version = "0.1.9";
const author = "一如既往 <h_gxi@foxmail.com>";
const type = "module";
const files = [
  "lib"
];
...
const repository = {
  type: "git",
  url: "https://gitee.com/han1982/vant-common.git"
};
const homepage = "https://gitee.com/han1982";
const keywords = [
  "vant",
  "vant-common"
];
...
export {
  _sfc_main$3 as Address,
  _sfc_main$2 as AddressSelect,
  Header,
  List,
  ListCell,
  NavBar,
